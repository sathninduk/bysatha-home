        ...
        return (
            <div>
                                    ...
                                    <div className={"row"}>
                                        <div className={"col-lg"}>
                                            ...
                                            <p className="full-name">
                                                NILVIN SATHNINDU KOTTAGE
                                                <br/>
                                                <span
                                                    className={"contact-details"}>(+94) 74 180 2242 | satha@bysatha.com</span>
                                            </p>
                ...
                <div className={"big-board-div"}>
                    <div className={"container"}>
                        <h1 className={"big-board"}>
                            I ain't a <span
                            style={{color: "#5765f1"}}>typical</span> developer.
                        </h1>
                        <h3>
                        ...
                        <div style={{transform: "rotate(-5deg)"}}>
                            <h1 className={"big-board"}
                                style={{textAlign: "right", fontSize: "2.5rem", color: "#5e5e5e"}}>
                                (+94) 74 180 2242
                            </h1>
                            <h1 className={"big-board"}
                                style={{textAlign: "right", fontSize: "2.5rem", color: "#5e5e5e"}}>
                ...
                <div className={"footer"}>
                    <div style={{backgroundImage: "url('/img/homepage/footer-main.png')"}}
