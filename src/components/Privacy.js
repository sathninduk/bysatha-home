            ...
            <div className={"con-mid"}>
                ...
                <div style={{padding: "20px", minHeight: "calc(100vh - 156px)"}}>
                    ...
                    <div className={"big-card"}>
                        <h1>Privacy Policy for EthPay</h1>
                        <p>At EthPay, accessible from ethpay.bysatha.com, one of our main priorities is the privacy of
                            our visitors. This Privacy Policy document contains types of information that is collected
                            and recorded by EthPay and how we use it.</p>
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in EthPay. This
                        ...
                        <p>When you connect with EthPay, we may save your ERC wallet's public key & the connected date
                            with EthPay. The other data we store are public keys and other public information such as
                            txHashes and block numbers to process your transactions. We <b>do not collect</b> any other
                            personal information, such as IP addresses, Names, Emails, Passwords & etc., directly. That
                            is our commitment to privacy and anonymity.</p>
                        <p>Third-party trackers & web beacons may save clients' IP addresses for analytical purposes
                            (ex: Netlify<sup>®</sup> CDN, Google<sup>®</sup> Analytics, Hotjar<sup>®</sup>,
                            Drift<sup>®</sup>, Microsoft<sup>®</sup> Clarity & etc.).</p>
                        ...
                        <p>Analytical supportive data</p>
                        <ul>
                        ...
                        <h2>Log Files</h2>
                        <p>EthPay follows a standard procedure of using log files. These files log visitors when they
                        ...
                        <p>Like any other website, EthPay uses 'cookies'. These cookies are used to store information
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                            Beacons that are used in their respective advertisements and links that appear on EthPay,
                            ...
                            visit.</p>
                        <p>Note that EthPay has no access to or control over these cookies that are used by third-party
                            advertisers.</p>
                        <h2>Third Party Privacy Policies</h2>
                        <p>EthPay's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                        ...
                        <p>Another part of our priority is adding protection for children while using the internet. We
                            ...
                            online activity.</p>
                        <p>EthPay does not knowingly collect any Personal Identifiable Information from children under
