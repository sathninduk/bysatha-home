            ...
            <div className={"con-mid"}>
                ...
                <div style={{padding: "20px", minHeight: "calc(100vh - 156px)"}}>
                    ...
                    <div className={"big-card"}>
                        ...
                        <p>Welcome to EthPay!</p>
                        <p>These terms and conditions outline the rules and regulations for the use of EthPay's Website,
                            located at https://ethpay.bysatha.com.</p>
                        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to
                            use EthPay if you do not agree to take all of the terms and conditions stated on this
                            page.</p>
                        ...
                        <h2>Cookies</h2>
                        <p>We employ the use of cookies. By accessing EthPay, you agreed to use cookies in agreement
                            with the EthPay's Privacy Policy. </p>
                        <p>Most interactive websites use cookies to let us retrieve the user’s details for each visit.
                            ...
                            use cookies.</p>
                        <h2>License</h2>
                        <p>Unless otherwise stated, EthPay and/or its licensors own the intellectual property rights for
                            all material on EthPay. All intellectual property rights are reserved. You may access this
                            from EthPay for your own personal use subjected to restrictions set in these terms and
                            conditions.</p>
                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from EthPay</li>
                            <li>Sell, rent or sub-license material from EthPay</li>
                            <li>Reproduce, duplicate or copy material from EthPay</li>
                            <li>Redistribute content from EthPay</li>
                        </ul>
                        <p>This Agreement shall begin on the date hereof.</p>
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                            information in certain areas of the website. EthPay does not filter, edit, publish or review
                            Comments prior to their presence on the website. Comments do not reflect the views and
                            opinions of EthPay,its agents and/or affiliates. Comments reflect the views and opinions of
                            the person who post their views and opinions. To the extent permitted by applicable laws,
                            EthPay shall not be liable for the Comments or for any liability, damages or expenses caused
                            and/or suffered as a result of any use of and/or posting of and/or appearance of the
                            Comments on this website.</p>
                        <p>EthPay reserves the right to monitor all Comments and to remove any Comments which can be
                        ...
                        <p>You hereby grant EthPay a non-exclusive license to use, reproduce, edit and authorize others
                        ...
                        <p>We will approve link requests from these organizations if we decide that: (a) the link would
                            ...
                            visibility of the hyperlink compensates the absence of EthPay; and (d) the link is in the
                            context of general resource information.</p>
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking
                            to our website, you must inform us by sending an e-mail to EthPay. Please include your name,
                        ...
                        <p>No use of EthPay's logo or other artwork will be allowed for linking absent a trademark
                            license agreement.</p>
                        <h2>iFrames</h2>
                        ...
                        <p>
                            <table>
                                <tr>
                                    ...
                                    <td><a href="mailto:ethpay@bysatha.com" className={"link"}>ethpay@bysatha.com</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style={{paddingRight: "20px", display: "flex"}}>Address:</td>
                                    <td>EthPay<br/>378/2, Samagi Mawata<br/>Biyagama (11650)<br/>Sri Lanka</td>
                                </tr>
                            </table>
                        </p>
                    </div>
